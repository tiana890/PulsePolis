...
//    func getJSON(parameters: [String: AnyObject], path: String) -> Observable<JSON>{
...
//            .debug()
//            .map({ (response, object) -> JSON in
//                return JSON(object)
//            })
//    }
//    
//    func postJSON(parameters: [String: AnyObject], path: String) -> Observable<JSON>{
//        
//    }
